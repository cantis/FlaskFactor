...
character_bp = Blueprint(
    'character_bp', __name__, template_folder='templates', static_folder='static'
)
...
class AddCharacterForm(FlaskForm):
    ...
    character_name = StringField(
        ...
        validators=[InputRequired('A Character name is required.')],
    )
